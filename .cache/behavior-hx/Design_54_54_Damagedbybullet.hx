...
class Design_54_54_Damagedbybullet extends ActorScript
{
	public var _Health:Float;
	public var _Animacion:String;
	...
	public function new(dummy:Int, actor:Actor, dummy2:Engine)
	{
		...
		_Health = 0.0;
		nameMap.set("Animacion", "_Animacion");
	...
	override public function init()
	{
		...
		addWhenUpdatedListener(null, function(elapsedTime:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				if((_Health <= 0))
				{
					setVolumeForAllSounds(65/100);
					playSound(getSound(44));
					actor.setAnimation(_Animacion);
