...
class Design_30_30_DrawRegions extends SceneScript
{
	...
	public function new(dummy:Int, dummy2:Engine)
	{
		...
		_OutlineColor = Utils.getColorRGB(153,204,255);
		nameMap.set("Fill Color", "_FillColor");
		_FillColor = Utils.getColorRGB(204,255,255);
					...
					for (region in engine.getRegions())
{
	...
	while(fixture != null)
	{
		...
		fixture = fixture.getNext();
				...
				if(_Fill)
				{
					g.fillColor = Utils.convertColor(_FillColor);
					g.strokeSize = 0;
