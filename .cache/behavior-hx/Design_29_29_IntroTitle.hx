...
class Design_29_29_IntroTitle extends SceneScript
{
	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				if(_DrawRectangle)
				{
					g.fillColor = Utils.convertColor(_FillColour);
					g.strokeColor = _StrokeColour;
					g.strokeSize = Std.int(_StrokeThickness);
					g.fillRoundRect((_XCentrePosition - ((g.font.font.getTextWidth(_AlternativeText, g.font.letterSpacing)/Engine.SCALE / 2) + _Padding)), (_YCentrePosition - ((g.font.getHeight()/Engine.SCALE / 2) + _Padding)), (g.font.font.getTextWidth(_AlternativeText, g.font.letterSpacing)/Engine.SCALE + (_Padding * 2)), (g.font.getHeight()/Engine.SCALE + (_Padding * 2)), _Rounding);
					g.drawRoundRect((_XCentrePosition - ((g.font.font.getTextWidth(_AlternativeText, g.font.letterSpacing)/Engine.SCALE / 2) + _Padding)), (_YCentrePosition - ((g.font.getHeight()/Engine.SCALE / 2) + _Padding)), (g.font.font.getTextWidth(_AlternativeText, g.font.letterSpacing)/Engine.SCALE + (_Padding * 2)), (g.font.getHeight()/Engine.SCALE + (_Padding * 2)), _Rounding);
				}
				g.drawString("" + _AlternativeText, (_XCentrePosition - (g.font.font.getTextWidth(_AlternativeText, g.font.letterSpacing)/Engine.SCALE / 2)), (_YCentrePosition - (g.font.getHeight()/Engine.SCALE / 2)));
			}
		});
